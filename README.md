...
Wish you could just make a shell script to manage vSphere (because EVERYTHING, including a 90's embedded mips security camera, supports shell scripts...but not Windows)?
